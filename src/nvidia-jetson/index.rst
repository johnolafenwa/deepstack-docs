...
.. code-block:: bash
    ...
    sudo docker pull deepquestai/deepstack:jetpack-2022.01.1
...
.. code-block:: bash
    ...
    sudo docker run --runtime nvidia -e VISION-SCENE=True -e VISION-DETECTION=True -e VISION-FACE=True  -p 80:5000 deepquestai/deepstack:jetpack-2022.01.1
