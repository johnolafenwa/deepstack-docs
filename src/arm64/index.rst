...
.. code-block:: bash
    ...
    sudo docker pull deepquestai/deepstack:arm64-2021.06.1
...
.. code-block:: bash
    ...
    sudo docker run -e VISION-DETECTION=True -p 80:5000 deepquestai/deepstack:arm64-2021.06.1
...
.. code-block:: bash
    ...
    sudo docker run -e VISION-SCENE=True -e VISION-DETECTION=True -e VISION-FACE=True  -p 80:5000 deepquestai/deepstack:arm64-2021.06.1
